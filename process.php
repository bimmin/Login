...
class Process{
	...
	public function __construct(){
		...
		else if(isset($_POST['action']) and $_POST['action'] == "addFriend"){
	...
	private function addFriendAction(){

		//I'll need to insert into friends loggedin user id with friend id, plus friend_id friends with logged in id

		echo $_POST['friend_id'];

		$query = "INSERT INTO friends VALUES('{$_SESSION['user']['id']}', '{$_POST['friend_id']}')";
		$queryReverse ="INSERT INTO friends VALUES('{$_POST['friend_id']}','{$_SESSION['user']['id']}')";
		header("Location: wall.php");
		mysql_query($query);
